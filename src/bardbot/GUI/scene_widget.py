...
class Ui_scene_widget(object):
    def setupUi(self, scene_widget):
        ...
        self.preset_tabs.setGeometry(QtCore.QRect(111, -2, 791, 184))
        self.preset_tabs.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.preset_tabs.setObjectName("preset_tabs")
        self.brawl_tab = QtWidgets.QWidget()
        self.brawl_tab.setObjectName("brawl_tab")
        self.channel_scroll_area_3 = QtWidgets.QScrollArea(self.brawl_tab)
        self.channel_scroll_area_3.setGeometry(QtCore.QRect(-1, -1, 789, 152))
        self.channel_scroll_area_3.setWidgetResizable(True)
        self.channel_scroll_area_3.setObjectName("channel_scroll_area_3")
        self.scrollAreaWidgetContents_3 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 787, 150))
        self.scrollAreaWidgetContents_3.setObjectName("scrollAreaWidgetContents_3")
        self.horizontalScrollBar_3 = QtWidgets.QScrollBar(self.scrollAreaWidgetContents_3)
        self.horizontalScrollBar_3.setGeometry(QtCore.QRect(0, 132, 791, 16))
        ...
        self.channel_scroll_area_3.setWidget(self.scrollAreaWidgetContents_3)
        self.preset_tabs.addTab(self.brawl_tab, "")
        self.festive_tab = QtWidgets.QWidget()
        self.festive_tab.setObjectName("festive_tab")
        self.channel_scroll_area_2 = QtWidgets.QScrollArea(self.festive_tab)
        self.channel_scroll_area_2.setGeometry(QtCore.QRect(-1, -1, 789, 152))
        self.channel_scroll_area_2.setWidgetResizable(True)
        self.channel_scroll_area_2.setObjectName("channel_scroll_area_2")
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 787, 150))
        self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_2")
        self.horizontalScrollBar_2 = QtWidgets.QScrollBar(self.scrollAreaWidgetContents_2)
        self.horizontalScrollBar_2.setGeometry(QtCore.QRect(0, 132, 791, 16))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.channel_scroll_area_2.setWidget(self.scrollAreaWidgetContents_2)
        self.preset_tabs.addTab(self.festive_tab, "")
        self.morning_tab = QtWidgets.QWidget()
        self.morning_tab.setObjectName("morning_tab")
        self.channel_scroll_area = QtWidgets.QScrollArea(self.morning_tab)
        self.channel_scroll_area.setGeometry(QtCore.QRect(-1, -1, 789, 152))
        self.channel_scroll_area.setWidgetResizable(True)
        self.channel_scroll_area.setObjectName("channel_scroll_area")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 787, 150))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.horizontalScrollBar = QtWidgets.QScrollBar(self.scrollAreaWidgetContents)
        self.horizontalScrollBar.setGeometry(QtCore.QRect(0, 132, 791, 16))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.channel_scroll_area.setWidget(self.scrollAreaWidgetContents)
        self.preset_tabs.addTab(self.morning_tab, "")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("GUI/icons/icons8-proximity-sensor-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("GUI/icons/icons8-sand-timer-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("GUI/icons/icons8-settings-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("GUI/icons/icons8-play-30.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("GUI/icons/icons8-adjustment-100.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.preset_tabs.setCurrentIndex(2)
